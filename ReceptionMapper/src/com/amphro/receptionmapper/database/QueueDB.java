...
public class QueueDB {
	...
	public static final String DATABASE_NAME = "QueueDatabase.db";
	public static final int DATABASE_VERSION = 1;

	/** Joke table information **/
	public static final String DATABASE_TABLE_QUEUE = "queue_table";

	public static final String REQUEST_KEY_ID = "_id";
	public static final int REQUEST_COL_ID = 0;

	public static final String REQUEST_KEY_TEXT = "request_text";
	public static final int REQUEST_COL_TEXT = REQUEST_COL_ID + 1;

	/** Database SQL **/
	public static final String DATABASE_CREATE = "create table " + DATABASE_TABLE_QUEUE + " (" + 
			REQUEST_KEY_ID + " integer primary key autoincrement, " + 
			REQUEST_KEY_TEXT	+ " text not null);";
	
	public static final String DATABASE_DROP = "drop table if exists " + DATABASE_TABLE_QUEUE;
