...
public class Grid implements Serializable {
	...
	public static String GRID_X(int level) {
		return "gss" + level + "x";
	}
	
	public static String GRID_Y(int level) {
		return "gss" + level + "y";
	}
	...
	public String toString() {
		return 
			...
			"GSS Y = "+gridY+" <br />"+
			"Level = "+level+" <br />"+
			"Average Reception = "+avgrec+" <br />" +
			"Average Network = "+avgnet+" <br />"+
			"Number of Uploads = "+numrec+" <br />"+
			"Carrier = "+carrier+" <br />";
	}
